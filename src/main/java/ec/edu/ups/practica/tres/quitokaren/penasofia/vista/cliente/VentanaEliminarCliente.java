...
public class VentanaEliminarCliente extends javax.swing.JInternalFrame {
     ...
     */
    public VentanaEliminarCliente(ControladorCompositor controladorCompositor, ControladorCantante controladorCantante) {
        initComponents();
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        int codigoC = Integer.parseInt(txtCodigo.getText());
        int codigoCantante = Integer.parseInt(txtCodigoCancion.getText());
 int respuesta = JOptionPane.showConfirmDialog(this, "¿Estas seguro que deseas eliminar el cliente?");
        if(respuesta == JOptionPane.YES_OPTION){
            if(controladorCompositor.eliminarCliente(codigoC, codigoCantante)){
                JOptionPane.showMessageDialog(this, "El cliente ha sido eliminada exitosamente! :)");
                this.limpiarCampos();                
            }else{
