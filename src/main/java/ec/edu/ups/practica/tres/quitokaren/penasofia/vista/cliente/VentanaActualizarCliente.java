...
public class VentanaActualizarCliente extends javax.swing.JInternalFrame {
     ...
     */
    public VentanaActualizarCliente(ControladorCompositor controladorCompositor, ControladorCantante controladorCantante) {
        initComponents();
    ...
    public void cambiarIdioma(Locale localizacion) {
        ...
        String borderTitle2 = mensajes.getString("jpanel.actualizarCliente");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        boolean t = controladorCompositor.actualizarCliente(codigoC, codigoCantante, nombre, apellido);
        if (t) {
